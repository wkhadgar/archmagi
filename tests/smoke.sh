...
declare -A expected=(
    ...
    [install]="cmd_install _install_boot _install_bootstrap _install_monitors _install_sync _install_detect_profile _install_detect_bootloader _install_detect_monitors _install_prompt_hostname _install_prompt_profile_role _install_prompt_confirm _install_substitute _install_configs _install_find_repo _install_packages _boot_grub _boot_limine"
