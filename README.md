...
- `archmagi install <bootstrap|boot|sync>` — bootstrap a fresh host, (re)apply the NERV bootloader theme, or diff-based pull changes from the live system back into the repo
...
- Re-apply the NERV bootloader theme if you regenerate the wallpaper: `archmagi install boot` (bootstrap already runs this once)
